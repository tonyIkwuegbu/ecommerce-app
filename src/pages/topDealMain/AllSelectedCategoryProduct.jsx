...
const AllSelectedCategoryProduct = ({ selectedCategory }) => {
	const navigate = useNavigate();
	const { openModal } = useContext(ModalContext);

	const { loading, shuffledData } = useFetch(
		`/api/v1/ecommerce/product/topdeals/${selectedCategory.category}?skip=0&limit=0`,
	);
...
export default AllSelectedCategoryProduct;
