...
import AllSelectedCategoryProduct from "./AllSelectedCategoryProduct";
...
const TopDealMain = () => {
	...
	return (
		<div className="flex flex-col justify-center items-center">
			...
			<div>
				{tabIndex === 1 && (
					<AllProductDisplay shuffledData={shuffledData} loading={loading} />
				)}
				{tabIndex >= 2 && (
					<AllSelectedCategoryProduct selectedCategory={selectedCategory} />
				)}
			</div>
		</div>
	);
