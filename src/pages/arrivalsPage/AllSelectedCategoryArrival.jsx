...
const AllSelectedCategoryArrival = ({ selectedCategory }) => {
	const navigate = useNavigate();
	const { openModal } = useContext(ModalContext);

	const { loading, shuffledData } = useFetch(
		`/api/v1/ecommerce/product/newarrival/${selectedCategory.category}?skip=0&limit=0`,
	);
...
export default AllSelectedCategoryArrival;
